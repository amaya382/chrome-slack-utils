...
Adds "Copy message as Markdown" and "Copy selected message as Markdown" options to Slack's message action menu. Converts Slack's rich text formatting (bold, italic, code blocks, lists, links, blockquotes, etc.) into clean Markdown.
